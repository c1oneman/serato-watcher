...
import org.ssldev.api.fields.Adat48SessionIdField;
...
import org.ssldev.api.fields.AdatField37;
...
import org.ssldev.api.fields.AdatField78;
/**
...
public class Adat extends ByteConsumer {
	...
	public String getAlbum() {
		ByteConsumerIF b = getData(Adat8AlbumField.ID);
		return null == b ? "" : (String) b.getData();
	}
	public String getGenre() {
		ByteConsumerIF b = getData(Adat9GenreField.ID);
		return null == b ? "" : (String) b.getData();
	}
	public String getComment() {
		ByteConsumerIF b = getData(Adat17CommentField.ID);
		return null == b ? "" : (String) b.getData();
	}
	...
	public int getSessionId() {
		ByteConsumerIF b = getData(Adat48SessionIdField.ID);
	...
	public String getPlayerType() {
		ByteConsumerIF b = getData(Adat63PlayerTypeField.ID);
		return null == b ? "" : (String) b.getData();
	}
	...
	private void constructAdat() {
		...
		register(new AdatField37()); 			// 37 
		register(new AdatField39()); 			// 39 
		register(new Adat45PlaytimeField()); 	// 45 
		register(new Adat48SessionIdField()); 	// 48 
